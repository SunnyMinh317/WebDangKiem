    ...
    const fetchData = async () => {
      try {
        ...
        if (chartType === "predict") {
          if (dateType === "month") {
            try {
              response = await axios.post("/dept/getRegByMonth", {
                regionName: city,
              });
            } catch (err) {
              console.error(err);
            ...
            try {
              response = await axios.post("/dept/getRegByQuarter", {
                regionName: city,
              });
            } catch (err) {
              console.error(err);
            ...
            try {
              response = await axios.post("/dept/getRegByYear", {
                regionName: city,
              });
            } catch (err) {
              console.error(err);
          ...
          if (dateType === "month") {
            try {
              response = await axios.post("/dept/getStatByMonth", {
                regionName: city,
              });
            } catch (err) {
              console.error(err);
            ...
            try {
              response = await axios.post("/dept/getStatByQuarter", {
                regionName: city,
              });
            } catch (err) {
              console.error(err);
            ...
            try {
              response = await axios.post("/dept/getStatByYear", {
                regionName: city,
              });
            } catch (err) {
              console.error(err);
    ...
    <div className={ChartCSS.container}>
      <div className={ChartCSS.titleCont}>
        <strong className={ChartCSS.title}>
          {chartType === "predict" ? "Biểu đồ dự đoán" : "Biểu đồ thống kê"}
        </strong>
        ...
        <div className={ChartCSS.dateInput}>
          ...
          >
            ...
            <FormControlLabel value="quart" control={<Radio />} label="Quý" />
